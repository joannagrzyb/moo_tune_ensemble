...
class MooEnsembleAllSVC(BaseEstimator):
    ...
    def partial_fit(self, X, y, classes=None):
        ...
        problem = OptimizationParamAll(X, y, test_size=self.test_size, estimator=self.base_classifier, scale_features=self.scale_features, n_features=n_features, n_classifiers=self.n_classifiers, objectives=self.objectives)
