...
def horizontal_bar_chart():
    for metric_id, metric in enumerate(metrics_alias):
        ...
        # Save plot
        # filename = "results/experiment1/9higher_part1/plot_bar/bar_%s" % (metric)
        # if not os.path.exists("results/experiment1/9higher_part1/plot_bar/"):
        #     os.makedirs("results/experiment1/9higher_part1/plot_bar/")
        filename = "results/experiment1/1_5_9/plot_bar/bar_%s" % (metric)
        if not os.path.exists("results/experiment1/1_5_9/plot_bar/"):
            os.makedirs("results/experiment1/1_5_9/plot_bar/")
